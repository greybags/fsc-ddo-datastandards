...
<xsl:stylesheet
  ...
  <xsl:key name="type"
           ...
           use="@name" />
  <xsl:key name="complexType"
           match="/xsd:schema/xsd:complexType | /xsd:schema/xsd:redefine/xsd:complexType"
           use="@name" />
  <xsl:key name="simpleType"
           match="/xsd:schema/xsd:simpleType | /xsd:schema/xsd:redefine/xsd:simpleType"
           use="@name" />
  <xsl:key name="attributeGroup"
           match="/xsd:schema/xsd:attributeGroup | /xsd:schema/xsd:redefine/xsd:attributeGroup"
           use="@name" />
  <xsl:key name="group"
           match="/xsd:schema/xsd:group | /xsd:schema/xsd:redefine/xsd:group"
           use="@name" />
  <xsl:key name="attribute"
           match="/xsd:schema/xsd:attribute"
           use="@name" />
  ...
  <xsl:param name="linksFile">xs3p-linksfile.xml</xsl:param>
  ...
  <xsl:variable name="CTYPE_PREFIX"
                select="$TYPE_PREFIX"/>
  ...
  <xsl:variable name="STYPE_PREFIX"
                select="$TYPE_PREFIX"/>
  <!-- Glossary terms -->
  ...
  <!-- The original schema needs to be stored because when
        ...
        template. -->
  <xsl:variable name="ORIGINAL_SCHEMA"
                select="/xsd:schema"/>
  ...
  <xsl:template match="/xsd:schema">
    ...
    <html>
      <head>
        ...
        <link href="{$bootstrapURL}/css/bootstrap.min.css"
              rel="stylesheet"
              charset="UTF-8"/>
...
@import url(</xsl:text>
        ...
        <xsl:element name="script"
                     >
          <xsl:attribute name="src">https://cdnjs.cloudflare.com/ajax/libs/pagedown/1.0/Markdown.Converter.js</xsl:attribute>
      ...
      <body data-spy="scroll"
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-3"
                 id="menu-cols">
              <div class="xs3p-sidebar hidden-print"
                   role="complementary">
            ...
            <div class="col-md-9 content"
              ...
              <xsl:if test="xsd:redefine">
                ...
                <xsl:apply-templates select="xsd:redefine/xsd:simpleType | xsd:redefine/xsd:complexType | xsd:redefine/xsd:attributeGroup | xsd:redefine/xsd:group"
                                     mode="topSection"/>
              </xsl:if>
              ...
              <xsl:choose>
                ...
                <xsl:when test="normalize-space(translate($sortByComponent,'TRUE','true'))='true'">
                  ...
                  <xsl:if test="xsd:attribute or xsd:element">
                    <section id="SectionSchemaDeclarations">
                      ...
                      <xsl:apply-templates select="xsd:attribute | xsd:element"
                                           mode="topSection">
                  ...
                  <xsl:if test="xsd:attributeGroup or xsd:complexType or xsd:group or xsd:notation or xsd:simpleType">
                    <section id="SectionSchemaDefinitions">
                      ...
                      <xsl:apply-templates select="xsd:attributeGroup | xsd:complexType | xsd:group | xsd:notation | xsd:simpleType"
                                           mode="topSection">
                        <xsl:sort select="local-name(.)"
                                  order="ascending"/>
                        <xsl:sort select="@name"
                ...
                <xsl:otherwise>
                  ...
                  <xsl:apply-templates select="xsd:attribute | xsd:attributeGroup | xsd:complexType | xsd:element | xsd:group | xsd:notation | xsd:simpleType"
                                       mode="topSection"/>
                </xsl:otherwise>
              </xsl:choose>
        ...
        <xsl:element name="script">
          <xsl:attribute name="src">
            <xsl:value-of select="$jQueryURL"></xsl:value-of>
          </xsl:attribute>
          <xsl:attribute name="type">text/javascript</xsl:attribute>
          <xsl:attribute name="charset">UTF-8</xsl:attribute>
          <xsl:text > </xsl:text>
        ...
        <xsl:element name="script">
          <xsl:attribute name="src">
            ...
            <xsl:value-of select="concat($bootstrapURL ,'/js/bootstrap.min.js')"></xsl:value-of>
          </xsl:attribute>
          <xsl:attribute name="type">text/javascript</xsl:attribute>
          <xsl:attribute name="charset">UTF-8</xsl:attribute>
          <xsl:text > </xsl:text>
...
.built-date {
  ...
  <xsl:template name="PrintSGroupMembers">
    ...
    <xsl:variable name="elemName"
                  select="normalize-space($element/@name)"/>
    <xsl:choose>
        ...
        <xsl:for-each select="/xsd:schema/xsd:element[normalize-space(@substitutionGroup)=$elemName or normalize-space(substring-after(@substitutionGroup, ':'))=$elemName]">
          ...
          <xsl:if test="not(contains($block, 'substitution'))">
            <xsl:call-template name="PrintSGroupMembers">
              <xsl:with-param name="element"
                              select="."/>
              <xsl:with-param name="elementList"
                              select="concat($elementList, '*', $elemName, '+')"/>
            </xsl:call-template>
          </xsl:if>
        </xsl:for-each>
      </xsl:otherwise>
  ...
  <xsl:template name="PrintComplexSubtypes">
    ...
    <xsl:variable name="typeName"
                  select="normalize-space($type/@name)"/>
    <xsl:choose>
      <!-- Circular type hierarchy -->
      <xsl:when test="contains($typeList, concat('*', $typeName, '+'))">
  ...
  <!--
     ...
     -->
  <xsl:template match="xsd:appinfo | xsd:documentation"
                mode="properties">
  ...
  <!--
     ...
     -->
  <xsl:template match="xsd:attributeGroup | xsd:group"
                mode="properties">
    <xsl:call-template name="CollapseableBox">
      <xsl:with-param name="id">
        <xsl:call-template name="GetComponentID">
  ...
  <xsl:template match="xsd:enumeration"
    ...
    <xsl:if test="./xsd:annotation/xsd:documentation">
      ...
      <xsl:variable name="typeName"
                    select="../parent::xsd:simpleType/@name"/>

      <div class="modal fade {$typeName}"
           id="{$documentation}-popup"
           tabindex="-1"
           role="dialog"
           aria-hidden="true">
  ...
  <xsl:template match="xsd:element | xsd:attribute | xsd:simpleType"
                mode="hiddendoc">
    <xsl:if test="./xsd:annotation/xsd:documentation">
      <xsl:variable name="documentation">
        <xsl:for-each select="./xsd:annotation/xsd:documentation">
  ...
  <xsl:template name="PrintAnnotation">
    ...
    <xsl:if test="$component/xsd:annotation/xsd:documentation">
      <xsl:for-each select="$component/xsd:annotation/xsd:documentation">
        ...
        <div class="annotation documentation"
             id="wdoc-{generate-id(.)}{$suffix}">
          <div class="hidden"
               id="{generate-id(.)}{$suffix}-doc-raw">
      ...
      <xsl:when test="$simpleContent/xsd:restriction">
        <xsl:call-template name="PrintSimpleRestriction">
          <xsl:with-param name="restriction"
                          select="$simpleContent/xsd:restriction"/>
          <xsl:with-param name="typeList"
                          select="$typeList"/>
        </xsl:call-template>
      </xsl:when>
          ...
          <li>
            ...
            <xsl:choose>
              ...
              <xsl:when test="$simpleContent/xsd:list/@itemType">
                <xsl:call-template name="PrintTypeRef">
                  <xsl:with-param name="ref"
                                  select="$simpleContent/xsd:list/@itemType"/>
                </xsl:call-template>
              </xsl:when>
              ...
              <xsl:if test="$simpleContent/xsd:union/@memberTypes">
                <xsl:call-template name="PrintWhitespaceList">
                  <xsl:with-param name="value"
                                  select="$simpleContent/xsd:union/@memberTypes"/>
  ...
  <xsl:template name="PrintSimpleRestriction">
    ...
    <xsl:variable name="typeName"
                  select="$restriction/parent::xsd:simpleType/@name"/>
    ...
    <xsl:choose>
      ...
      <xsl:when test="$restriction/xsd:simpleType">
        <xsl:call-template name="PrintSimpleConstraints">
          <xsl:with-param name="simpleContent"
                          select="$restriction/xsd:simpleType"/>
          <xsl:with-param name="typeList"
                          select="$typeList"/>
        </xsl:call-template>
      </xsl:when>
      ...
      <xsl:when test="$restriction">
        ...
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:variable name="baseType"
                          select="key('simpleType', $baseTypeName)"/>
            <xsl:choose>
              <!-- Base type found -->
              <xsl:when test="$baseType">
                <xsl:call-template name="PrintSimpleConstraints">
    ...
    <xsl:variable name="enumeration">
      <xsl:call-template name="PrintEnumFacets">
        <xsl:with-param name="simpleRestrict"
                        select="$restriction"/>
      </xsl:call-template>
    </xsl:variable>
    ...
    <xsl:if test="normalize-space(@maxOccurs)!='0'">
      ...
      <xsl:apply-templates select="xsd:*"
        ...
        <xsl:with-param name="margin"
                        select="number($margin) + number($ELEM_INDENT)"/>
        <xsl:with-param name="isInherited"
                        select="$isInherited"/>
        <xsl:with-param name="isNewField"
                        select="$isNewField"/>
        <xsl:with-param name="schemaLoc"
                        select="$schemaLoc"/>
        <xsl:with-param name="typeList"
                        select="$typeList"/>
      </xsl:apply-templates>
  ...
  <!--
     ...
     Param(s):
            margin (nonNegativeInteger) optional
                Number of 'em' to indent from left
     -->
  <xsl:template match="xsd:any | xsd:anyAttribute"
                mode="sample">
    <xsl:param name="margin">0</xsl:param>
    ...
    <xsl:call-template name="PrintWildcard">
      ...
      <xsl:with-param name="namespace"
                      select="@namespace"/>
      <xsl:with-param name="processContents"
                      select="@processContents"/>
      <xsl:with-param name="minOccurs"
                      select="@minOccurs"/>
      <xsl:with-param name="maxOccurs"
                      select="@maxOccurs"/>
      <xsl:with-param name="margin"
                      select="number($margin)"/>
    </xsl:call-template>
  </xsl:template>
            ...
            <xsl:choose>
              ...
              <xsl:when test="normalize-space($defLoc)='this'">
                <xsl:variable name="ctype"
                              select="key('complexType', $elemTypeName)"/>
                <xsl:call-template name="PrintSampleComplexElement">
                  <xsl:with-param name="element"
                                  select="."/>
                  <xsl:with-param name="type"
  ...
  <xsl:template match="xsd:group[@name]"
    ...
    <xsl:apply-templates select="xsd:*"
                         mode="sample">
      <xsl:with-param name="parentGroups"
                      select="concat('*', normalize-space(@name), '+')"/>
      <xsl:with-param name="schemaLoc"
                      select="$schemaLoc"/>
      <xsl:with-param name="typeList"
                      select="$typeList"/>
      ...
      <xsl:otherwise>
        ...
        <xsl:choose>
          ...
          <xsl:when test="normalize-space($grpDefLoc)='this'">
            <xsl:variable name="grpDef"
                          select="key('group', $grpName)"/>
            <xsl:call-template name="PrintSampleGroup">
              ...
              <xsl:with-param name="occursInfo"
                              select="$occursInfo"/>
              <xsl:with-param name="grpLink"
                              select="$grpLink"/>
              <xsl:with-param name="grpRef"
                              select="."/>
              <xsl:with-param name="grpDef"
                              select="$grpDef"/>
              <xsl:with-param name="grpDefLoc"
                              select="$grpDefLoc"/>
              <xsl:with-param name="typeList"
                              select="$typeList"/>
            </xsl:call-template>
          ...
          <xsl:otherwise>
            <xsl:variable name="grpDef"
                          select="document($grpDefLoc)/xsd:schema/xsd:group[@name=$grpName]"/>
            <xsl:call-template name="PrintSampleGroup">
              <xsl:with-param name="margin"
                              select="$margin"/>
              <xsl:with-param name="isInherited"
  ...
  <!--
     ...
     Param(s):
            schemaLoc (String) optional
                ...
                set to 'this'
     -->
  <xsl:template match="xsd:simpleContent[xsd:restriction]"
                mode="sample">
    <xsl:param name="schemaLoc">this</xsl:param>
  ...
  <!--
     ...
     Param(s):
            ...
            schemaLoc (String) optional
                ...
                if in current schema, 'schemaLoc' is set to 'this'
     -->
  <xsl:template match="xsd:unique | xsd:key | xsd:keyref"
                mode="sample">
    <xsl:param name="margin">0</xsl:param>
    <xsl:param name="schemaLoc">this</xsl:param>
    ...
    <span class="c">
      ...
      <xsl:call-template name="Repeat">
        ...
        <xsl:with-param name="count"
                        select="number($margin) + number($ATTR_INDENT)"/>
      </xsl:call-template>
      <xsl:choose>
  ...
  <xsl:template name="PrintSampleDocumentation">
    ...
    <xsl:if test="$component and $component/xsd:annotation/xsd:documentation">
      ...
      <xsl:text> </xsl:text>
      <button title="Show documentation for {$component/@name}"
              class="btn btn-link btn-doc"
              data-toggle="modal"
              data-target="#{$documentation}-popup">
  ...
  <xsl:template name="PrintSampleGroup">
    ...
    <!-- Content -->
    <xsl:apply-templates select="$grpDef/xsd:*"
                         mode="sample">
      <xsl:with-param name="margin">
        <xsl:choose>
          <xsl:when test="normalize-space($occursInfo)!='[1]'">
  ...
  <xsl:template name="PrintSampleSimpleElement">
    ...
    <xsl:element name="span">
      ...
      <xsl:text>&lt;</xsl:text>
      <!--SC<xsl:copy-of select="$elemTag"/>-->
      <xsl:value-of select="$elemTag"/>
      <xsl:text>></xsl:text>
    </xsl:element>
    ...
    <xsl:choose>
      ...
      <xsl:when test="$element/@name and $element/xsd:simpleType">
        <xsl:apply-templates select="$element/xsd:simpleType"
                             mode="sample">
          <xsl:with-param name="schemaLoc"
                          select="$schemaLoc"/>
        </xsl:apply-templates>
      ...
      <xsl:otherwise>
        ...
        <xsl:variable name="attributes">
          <xsl:call-template name="PrintSampleTypeAttrs">
            ...
            <xsl:with-param name="margin"
                            select="number($margin) + number($ATTR_INDENT)"/>
            <xsl:with-param name="fromTopCType"
                            select="$fromTopCType"/>
            <xsl:with-param name="schemaLoc"
                            select="$schemaLoc"/>
            <xsl:with-param name="typeList"
          ...
          <xsl:otherwise>
            ...
            <xsl:choose>
              <xsl:when test="false()">
                ...
                <br/>
                <span class="other"
                      style="margin-left: {$ELEM_INDENT}em">
        ...
        <xsl:choose>
          <xsl:when test="$type/xsd:complexContent/xsd:restriction">
            <xsl:call-template name="PrintSampleDerivedTypeAttrs">
              <xsl:with-param name="derivationElem"
                              select="$type/xsd:complexContent/xsd:restriction"/>
              <xsl:with-param name="subTypeAttrs"
                              select="$subTypeAttrs"/>
              <xsl:with-param name="isInherited"
                              select="$isInherited"/>
              ...
              <xsl:with-param name="schemaLoc"
                              select="$schemaLoc"/>
              <xsl:with-param name="typeList"
                              select="concat($typeList, '*', $type/@name, '+')"/>
            </xsl:call-template>
          </xsl:when>
          <xsl:when test="$type/xsd:simpleContent/xsd:restriction">
            <xsl:call-template name="PrintSampleDerivedTypeAttrs">
              <xsl:with-param name="derivationElem"
                              select="$type/xsd:simpleContent/xsd:restriction"/>
              <xsl:with-param name="subTypeAttrs"
                              select="$subTypeAttrs"/>
              <xsl:with-param name="isInherited"
                              select="$isInherited"/>
          ...
          <xsl:when test="$type/xsd:complexContent/xsd:extension">
            <xsl:call-template name="PrintSampleDerivedTypeAttrs">
              <xsl:with-param name="derivationElem"
                              select="$type/xsd:complexContent/xsd:extension"/>
              <xsl:with-param name="subTypeAttrs"
                              select="$subTypeAttrs"/>
              <xsl:with-param name="isInherited"
                              select="$isInherited"/>
          ...
          <xsl:when test="$type/xsd:simpleContent/xsd:extension">
            <xsl:call-template name="PrintSampleDerivedTypeAttrs">
              <xsl:with-param name="derivationElem"
                              select="$type/xsd:simpleContent/xsd:extension"/>
              <xsl:with-param name="subTypeAttrs"
                              select="$subTypeAttrs"/>
              <xsl:with-param name="isInherited"
                              select="$isInherited"/>
  ...
  <xsl:template name="PrintSampleDerivedTypeAttrs">
    ...
    <xsl:choose>
      ...
      <xsl:when test="normalize-space($defLoc)='this'">
        <xsl:variable name="ctype"
                      select="key('complexType', $baseTypeName)"/>
        <xsl:call-template name="PrintSampleTypeAttrs">
          <xsl:with-param name="type"
                          select="$ctype"/>
          <xsl:with-param name="subTypeAttrs"
                          select="concat($subTypeAttrs, $thisAttrs)"/>
          <xsl:with-param name="isInherited">
            <xsl:choose>
    ...
    <xsl:choose>
      ...
      <xsl:when test="$type/xsd:simpleContent/xsd:restriction">
        ...
        <span style="margin-left: {$margin}em">
          <xsl:text> </xsl:text>
          <xsl:apply-templates select="$type/xsd:simpleContent"
                               mode="sample">
            <xsl:with-param name="schemaLoc"
                            select="$schemaLoc"/>
          </xsl:apply-templates>
      ...
      <xsl:when test="$type/xsd:simpleContent/xsd:extension">
        ...
        <xsl:call-template name="PrintTypeRef">
          <xsl:with-param name="ref"
                          select="$type/xsd:simpleContent/xsd:extension/@base"/>
          <xsl:with-param name="schemaLoc"
                          select="$schemaLoc"/>
        </xsl:call-template>
        <xsl:text>&#xa;</xsl:text>
  ...
  <xsl:template name="PrintSampleParticleList">
    ...
    <xsl:if test="$list">
      <xsl:apply-templates select="$list/xsd:group | $list/xsd:sequence | $list/xsd:choice | $list/xsd:all | $list/xsd:element"
                           mode="sample">
        <xsl:with-param name="margin"
                        select="$margin"/>
        <xsl:with-param name="isInherited"
  ...
  <!--
     ...
     Param(s):
            margin (nonNegativeInteger) optional
                Number of 'em' to indent from left
     -->
  <xsl:template match="xsd:attribute[@name] | xsd:element[@name]"
                mode="schemaComponent">
    <xsl:param name="margin">0</xsl:param>
  ...
  <!--
     ...
     Param(s):
            margin (nonNegativeInteger) optional
                Number of 'em' to indent from left
     -->
  <xsl:template match="xsd:attributeGroup[@name] | xsd:complexType[@name] | xsd:simpleType[@name] | xsd:group[@name] | xsd:key | xsd:unique"
                mode="schemaComponent">
    <xsl:param name="margin">0</xsl:param>
        ...
        <xsl:if test="@itemType">
          <xsl:call-template name="DisplayAttr">
            ...
            <xsl:with-param name="attrValue">
              <xsl:call-template name="PrintTypeRef">
                <xsl:with-param name="ref"
                                select="normalize-space(@itemType)"/>
              </xsl:call-template>
            </xsl:with-param>
          </xsl:call-template>
        </xsl:if>
        ...
        <xsl:if test="@memberTypes">
          <xsl:call-template name="DisplayAttr">
            ...
            <xsl:with-param name="attrValue">
              <xsl:call-template name="PrintWhitespaceList">
                <xsl:with-param name="value"
                                select="normalize-space(@memberTypes)"/>
                <xsl:with-param name="compType">type</xsl:with-param>
              </xsl:call-template>
            </xsl:with-param>
          </xsl:call-template>
      ...
      <xsl:with-param name="attributes">
        ...
        <xsl:if test="@xml:lang">
          <xsl:call-template name="DisplayAttr">
            ...
            <xsl:with-param name="attrValue"
                            select="normalize-space(@xml:lang)"/>
          </xsl:call-template>
        </xsl:if>
        <!-- Other attributes -->
        <xsl:call-template name="DisplayOtherAttributes">
    ...
    <xsl:variable name="content">
      <xsl:choose>
        ...
        <xsl:when test="$includeFilter!=''">
          <xsl:apply-templates select="$component/xsd:*[contains($includeFilter, concat('*', local-name(.), '+'))]"
                               mode="schemaComponent">
            <xsl:with-param name="margin"
                            select="$ELEM_INDENT"/>
          </xsl:apply-templates>
        ...
        <xsl:when test="$excludeFilter!=''">
          <xsl:apply-templates select="comment() | $component/xsd:*[not(contains($excludeFilter, concat('*', local-name(.), '+')))]"
                               mode="schemaComponent">
            <xsl:with-param name="margin"
                            select="number($margin) + number($ELEM_INDENT)"/>
          </xsl:apply-templates>
        ...
        <xsl:when test="$hasAnyContent='true'">
          <div class="scContent"
               style="margin-left: {$ELEM_INDENT}em">
            <xsl:apply-templates select="comment() | $component/* | $component/text()"
                                 mode="xpp"/>
          </div>
        </xsl:when>
        <!-- Contains schema elements -->
        <xsl:otherwise>
          <xsl:apply-templates select="comment() | $component/xsd:*"
                               mode="schemaComponent">
            <xsl:with-param name="margin"
                            select="number($margin) + number($ELEM_INDENT)"/>
          </xsl:apply-templates>
      ...
      <xsl:if test="not(contains($attrsNotToDisplay, concat('*', $attrName, '+')))">
        <xsl:call-template name="DisplayAttr">
          <xsl:with-param name="attrName"
                          select="normalize-space($attrName)"/>
          <xsl:with-param name="attrValue"
      ...
      <xsl:when test="$element/* | $element/text()">
        ...
        <xsl:choose>
          <xsl:when test="$mode!='xpp'">
            <xsl:apply-templates select="$element/* | $element/text()"
                                 mode="html"/>
          </xsl:when>
          <xsl:otherwise>
            <div class="fakeclass3"
                 style="margin-left: {$ELEM_INDENT}em">
              <xsl:apply-templates select="$element/* | $element/text()"
                                   mode="xpp"/>
            </div>
    ...
    <xsl:if test="$prefix!=''">
      <xsl:choose>
        <xsl:when test="/xsd:schema/namespace::*[local-name(.)=normalize-space($prefix)]">
          ...
          <a href="{$link}"
             title="Find out namespace of '{$prefix}' prefix">
            <xsl:value-of select="$prefix"/>
          </a>
        </xsl:when>
        <xsl:otherwise>
  ...
  <xsl:template name="FindComponent">
    ...
    <xsl:choose>
      ...
      <xsl:when test="($refPrefix=$tnPrefix) or (/xsd:schema/namespace::*[local-name(.)=normalize-space($refPrefix)] = normalize-space(/xsd:schema/@targetNamespace))">
        <!-- SC -->
  ...
  <xsl:template name="FindComponentInIncludedSchemas">
    ...
    <xsl:if test="count($schema/xsd:include) &gt;= number($index)">
      ...
      <xsl:variable name="schemaLoc"
                    select="$schema/xsd:include[position()=$index]/@schemaLocation"/>
      ...
      <xsl:variable name="thisResult">
        ...
        <xsl:call-template name="FindComponentInSchema">
          ...
          <xsl:with-param name="compType"
                          select="$compType"/>
          <xsl:with-param name="schema"
                          select="document($schemaLoc)/xsd:schema"/>
          <xsl:with-param name="schemaFileLoc"
                          select="$schemaLoc"/>
          <xsl:with-param name="schemasSearched"
                          select="$schemasSearched"/>
        </xsl:call-template>
      </xsl:variable>
      ...
      <xsl:choose>
        ...
        <xsl:otherwise>
          ...
          <xsl:call-template name="FindComponentInIncludedSchemas">
            ...
            <xsl:with-param name="schemasSearched"
                            select="concat($schemasSearched, '*', $schemaLoc, '+')"/>
          </xsl:call-template>
        </xsl:otherwise>
      </xsl:choose>
    </xsl:if>
  ...
  <xsl:template name="FindComponentInRedefinedSchemas">
    ...
    <xsl:if test="count($schema/xsd:redefine) &gt;= number($index)">
      <!-- Get the 'schemaLocation' attribute of the 'redefine'
              element in this schema at position, 'index'. -->
      <xsl:variable name="schemaLoc"
                    select="$schema/xsd:redefine[position()=$index]/@schemaLocation"/>
  ...
  <xsl:template name="FindComponentInImportedSchemas">
    ...
    <xsl:if test="count($schema/xsd:import) &gt;= number($index)">
      <!-- Get the 'namespace' attribute of the 'import'
              element in this schema at position, 'index'. -->
      <xsl:variable name="schemaNS"
                    select="$schema/xsd:import[position()=$index]/@namespace"/>
      <!-- Get the 'schemaLocation' attribute. -->
      <xsl:variable name="schemaLoc"
                    select="$schema/xsd:import[position()=$index]/@schemaLocation"/>
  ...
  <xsl:template name="CollapseableBox">
    ...
    <div class="panel-group"
         id="{$id}-{$anchor}-panel-group">
      <div class="panel panel-default">
        <div class="panel-heading">
          <!-- Box Title -->
          <h4 class="panel-title">
            <a class="{$panelTitleClass}"
               data-toggle="collapse"
               data-parent="#{$id}-{$anchor}-panel-group"
               href="#{$id}-{$anchor}-collapse">
        ...
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:element name="div">
              <xsl:attribute name="id">
                <xsl:value-of select="concat(concat(concat($id, '-'), $anchor), '-collapse')"/>
              </xsl:attribute>
              <xsl:attribute name="class">
                <xsl:value-of select="$panelContentClass"/>
              </xsl:attribute>
              <xsl:element name="div">
                <xsl:attribute name="class">panel-body</xsl:attribute>
                <xsl:choose>
                  <xsl:when test="not(normalize-space($contents))">
                    <xsl:text>No documentation provided.</xsl:text>
                  </xsl:when>
                  <xsl:when test="normalize-space(translate($containsCode,'TRUE','true'))='true'">
                    <xsl:element name="pre">
                      <xsl:attribute name="class">codehilite</xsl:attribute><xsl:text>&#xA;</xsl:text><code>
<!-- This must start on a new line for output! -->
<xsl:copy-of select="$contents"/></code>
                    </xsl:element>
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:copy-of select="$contents"/>
  ...
  <xsl:template name="PrintSchemaLink">
    ...
    <xsl:choose>
      <xsl:when test="$docFileLoc!=''">
        <a title="Jump to schema documentation for '{$uri}'."
           href="{$docFileLoc}">
          <xsl:value-of select="$uri"/>
        </a>
      </xsl:when>
  ...
  <xsl:template name="PrintWhitespaceList">
    ...
    <xsl:variable name="token"
                  select="normalize-space(substring-before($value, ' '))"/>
    <xsl:choose>
      <xsl:when test="$token!=''">
        ...
        <xsl:variable name="rest"
                      select="normalize-space(substring-after($value, $token))"/>
        <xsl:if test="$rest!=''">
          <xsl:call-template name="PrintWhitespaceList">
            <xsl:with-param name="value"
                            select="$rest"/>
      ...
      <xsl:choose>
        ...
        <xsl:otherwise>
          ...
          <xsl:if test="$hasSpecificNS='true'">
            ...
            <xsl:call-template name="PrintWhitespaceList">
              <xsl:with-param name="value"
                              select="normalize-space($specificNS)"/>
              <xsl:with-param name="separator">,</xsl:with-param>
            </xsl:call-template>
          </xsl:if>
        </xsl:otherwise>
  ...
  <xsl:template name="TranslateStr">
    ...
    <xsl:if test="$value != ''">
      <xsl:variable name="beforeText"
                    select="substring-before($value, $strToReplace)"/>
      <xsl:choose>
        <xsl:when test="$beforeText != ''">
          ...
          <xsl:call-template name="TranslateStr">
            <xsl:with-param name="value"
                            select="substring-after($value, $strToReplace)"/>
            <xsl:with-param name="strToReplace"
                            select="$strToReplace"/>
            <xsl:with-param name="replacementStr"
                            select="$replacementStr"/>
          </xsl:call-template>
        </xsl:when>
        <xsl:otherwise>
          <xsl:value-of select="$value"/>
